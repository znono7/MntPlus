...
namespace MntPlus.WPF
{
    public class MainWindowViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// The command to toggle the theme
        /// </summary>
        ...
        public MainWindowViewModel(Window window)
        {
            ...
            ToggleThemeCommand = new RelayParameterizedCommand(async (parameter) => await SetThemes(parameter));
        ...
        /// <returns></returns>
        private async Task  SetThemes(object parameter)
        {
